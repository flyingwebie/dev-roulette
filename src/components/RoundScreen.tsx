...
export function RoundScreen({ round, totalRounds, timeLeft, totalTime, iceBreaker, isPaused, onPause, onResume, onSkip }: { round: number; totalRounds: number; timeLeft: number; totalTime: number; iceBreaker: string; isPaused: boolean; onPause: () => void; onResume: () => void; onSkip: () => void }) {
