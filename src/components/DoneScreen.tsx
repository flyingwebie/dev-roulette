...
export function DoneScreen({ totalRounds, onRestart }: { totalRounds: number; onRestart: () => void }) {
  return (
    <motion.div
      ...
      style={{ background: "radial-gradient(ellipse at center, #1a0a2e 0%, #0a0a0a 70%)", minHeight: 0 }}>
      <motion.div
        ...
        <button
          ...
          style={{ fontFamily: "'JetBrains Mono', monospace", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "#f97316" }}>
          Start New Event
        </button>
      </motion.div>
    </motion.div>
